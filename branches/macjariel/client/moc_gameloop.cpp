...
**
** Created: Sat Nov 8 21:35:36 2008
...
static const char qt_meta_stringdata_GameLoop[] = {
    "GameLoop\0"
};

const QMetaObject GameLoop::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_GameLoop,
      qt_meta_data_GameLoop, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameLoop))
