...
/**
 * The StanzaQuery class represents the query stanzas recieved from client.
 * The type attribute of these stanzas must be always get, otherwise an error
 * is returned to the client. The query stanza will have the following structure:
 * <query type="get" id="1">
