        ...
        QWidget(parent)
{
    ...
    localCardsetsWidget->header()->setResizeMode(1, QHeaderView::ResizeToContents);
    localCardsetsWidget->header()->setResizeMode(2, QHeaderView::ResizeToContents);
}
...
void OptionsCardsetsUI::setRemoteCardsetsModel(QAbstractItemModel* model)
{
    ...
    remoteCardsetsWidget->header()->setResizeMode(1, QHeaderView::ResizeToContents);
    remoteCardsetsWidget->header()->setResizeMode(2, QHeaderView::ResizeToContents);
    remoteCardsetsWidget->header()->setResizeMode(3, QHeaderView::Fixed);
    remoteCardsetsWidget->setColumnWidth(3, 48);
}

OptionsCardsets::OptionsCardsets(OptionsDialog* optionsDialog):
        OptionsTab(optionsDialog, "cardsets", "Card Sets", "Cardset setup"),
        mp_widget(0),
